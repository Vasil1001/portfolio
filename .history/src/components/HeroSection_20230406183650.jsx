  ...
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#ecf0f4] p-4 pt-8 text-center shadow-sm">
        ...
        <a href="#" className='inline-block px-8 py-3 mt-3  text-base font-medium font-inter rounded-md text-gray-800 shadow-lg bg-gradient-to-r from-[#f0f8ff] to-[#f7f7f8] hover:border-gray-500 hover:shadow-lg'>See Projects</a>
