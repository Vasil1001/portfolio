...
export default function Navbar() {
  return (
    <div className="flex justify-between px-2 mb-4">
      ...
      <div className="flex p-4 gap-4 shadow-xl rounded-xl bg-gradient-to-r from-[#e8f4ff] to-[#f7f7f8] hover:from-[#f0f8ff] hover:to-[#fdf4ec] border border-gray-200 hover: hover:shadow-xl ">
