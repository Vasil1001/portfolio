...
export default function Navbar() {
  return (
    <div className="align-center mb-3.5 flex items-end justify-between px-2">
      ...
      <div className="flex hidden gap-4 rounded-2xl border flex-col border-gray-300 bg-gradient-to-r from-[#f0f8ff] to-[#f7f7f8] p-1.5 shadow-md hover:border-gray-300 hover:from-[#f0f8ff] hover:to-[#fdf4ec] hover:shadow-lg md:block ">
