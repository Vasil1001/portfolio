...
export default function HeroSection() {
  //BLUEISH GRAY CARDS e2e8f0 dark mode | light mode eaeff4  f6f6f6 LIGHT GRAY CARDS e6edf6 ecf0f4 | eaeff4 f1f1f1 | cccdcf
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#f0f8ff] p-7 text-center border border-[#d8d9da]">
