      ...
      <div className="mt-5 grid grid-cols-2 gap-5">
        <div className="rounded-2xl bg-[#202124] p-8 py-40 text-center shadow-sm">
          <div className="grid-span-1 grid grid-cols-2 justify-between rounded-2xl bg-[#393E46] p-5">
            ...
            <div className="flex flex-wrap p-8 justify-end">
        ...
        <div className=" rounded-2xl bg-[#393E46] p-8 py-40 text-center shadow-sm">
          <div className="grid-span-1 grid grid-cols-2 justify-between rounded-2xl bg-[#545b64] p-5">
