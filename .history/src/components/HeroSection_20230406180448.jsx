  ...
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#ecf0f4] p-4 pt-8 text-center shadow-sm">
        <h1 className="mb-1 font-noto text-2xl font-semibold text-[#222831] md:mb-3 md:text-4xl">I am a Computer Science graduate working with React, Tailwind, NodeJS and more on personal projects!Hi, I'm Vasilis (Βασίλης) </h1>
        <p className="text-md text-center  max-w-md font-inter text-gray-600 md:text-lg">
        ...
        <div className="rounded-2xl bg-[#202124] p-8 py-40 text-center shadow-sm">
          <div className="grid-span-1 grid grid-cols-2 justify-between rounded-2xl bg-[#393E46] p-5">
            <div className="z-10 col-span-1 flex flex-row flex-wrap justify-start">
              <p className="text-left text-xl font-bold text-[#00ADB5]">Hello this is Βασίλης</p>
