...
export default function HeroSection() {
  ...
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#ecf0f4] p-7 text-center shadow-sm">
        <h1 className="mb-1 font-noto text-left text-2xl font-semibold text-[#222831] md:mb-3 md:text-4xl">Hi, I'm Vasilis (Βασίλης) </h1>
        ...
        <a href="#" className='inline-block px-6 py-2 mt-3 text-base font-medium font-inter rounded-md text-gray-700 shadow-md border border-gray-200 hover:border-gray-300 bg-gradient-to-r from-[#f0f8ff] to-[#f7f7f8] hover:from-[#f0f8ff] hover:to-[#fdf4ec] border-gray-500 hover:shadow-xl'>See Projects</a>
