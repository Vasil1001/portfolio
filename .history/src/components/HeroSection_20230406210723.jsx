...
export default function HeroSection() {
  //e2e8f0 BLUEISH GRAY CARDS f6f6f6 LIGHT GRAY CARDS e6edf6 ecf0f4 | eaeff4 f1f1f1 
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#f1f1f1] p-7 text-center shadow-sm border border-[#cccdcf]">
