  ...
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#ecf0f4] p-4 pt-8 text-center shadow-sm">
        ...
        <a href="#" className='inline-block px-6 py-2 mt-3 text-base font-bold font-inter rounded-md text-gray-600 shadow-md bg-gradient-to-r from-[#e8f4ff] to-[#f7f7f8] hover:from-[#f0f8ff] hover:to-[#fdf4ec] border-gray-500 hover:shadow-xl'>See Projects</a>
