...
export default function HeroSection() {
  ...
  return (
    <div className="w-full mx-auto lg:w-10/12 flex flex-col items-center justify-center py-10">
      <div className="rounded-2xl bg-[#ecf0f4] p-4 pt-8 text-center shadow-sm">
        ...
        <p className="text-md max-w-md font-inter text-gray-600 md:text-lg">
