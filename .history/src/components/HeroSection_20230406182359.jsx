  ...
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#ecf0f4] p-4 pt-8 text-center shadow-sm">
        ...
        <a href="#" className='inline-block px-8 py-3 mt-3 border border-transparent text-base font-medium font-inter rounded-md text-[#ecf0f4] bg-[#1EA896]'>See Projects</a>
