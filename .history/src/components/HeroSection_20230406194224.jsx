  ...
  return (
    <div className="w-full items-center justify-center">
      <div className="rounded-2xl bg-[#ecf0f4] p-7 text-center shadow-sm">
        ...
        <a href="#" className='inline-block px-6 py-2 mt-3 text-base font-medium font-inter rounded-md text-gray-700 shadow-md border border-gray-200 hover:border-gray-300 bg-gradient-to-r from-[#f0f8ff] to-[#f7f7f8] hover:from-[#f0f8ff] hover:to-[#fdf4ec] hover:shadow-xl'>See Projects</a>
        e8f4ff
