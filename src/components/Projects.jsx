...
export default function Projects() {
  return (
    <div className="mt-3.5"> 
      ...
      <div className="grid grid-cols-4 space-x-3.5">
        <div className="col-span-2 row-span-6 mt-3.5 rounded-2xl border border-[#d8d9da] bg-[#f1f1f5] p-7 text-center dark:border-[#434345] dark:bg-[#f1f1f5] md:col-span-2">
          <h1 className="mb-1 text-left font-noto text-3xl font-semibold text-[#222831]  md:mb-3 md:text-4xl">2 Renting Marketplace</h1>
          <p className="text-md md:text-md max-w-md text-left font-roboto text-gray-500 dark:text-gray-600 md:text-lg">
            This is a project I created to help people find the best foods in the world. I used ReactJS and Vanilla CSS!
          </p>
        ...
        <div className="col-span-2 mt-3.5 rounded-2xl border border-[#d8d9da] bg-[#f1f1f5] p-7 text-center lg:col-span-1">
          <h1 className="mb-1 text-left font-noto text-3xl font-semibold text-[#222831] md:mb-3 md:text-4xl">SwiftUI</h1>
      ...
      <div className="grid grid-cols-4 space-x-3.5">
        <div className="col-span-2 row-span-6 mt-3.5 rounded-2xl border border-[#d8d9da] bg-[#edeeef] p-7 text-center dark:border-[#434345] dark:bg-[#f1f1f5] md:col-span-2">
          <h1 className="mb-1 text-left font-noto text-3xl font-semibold text-[#222831]  md:mb-3 md:text-4xl">Nutrition Project</h1>
          <p className="text-md md:text-md max-w-md text-left font-roboto text-gray-500 dark:text-gray-600 md:text-lg">
            This is a project I created to help people find the best foods in the world. I used ReactJS and Vanilla CSS!
          </p>
        ...
        <div className="col-span-2 mt-3.5 rounded-2xl border border-[#d8d9da] bg-[#edeeef] p-7 text-center lg:col-span-2">
          <h1 className="mb-1 text-left font-noto text-3xl font-semibold text-[#222831] md:mb-3 md:text-4xl">NodeJS Project</h1>
          <p className="text-md max-w-md text-left font-inter text-gray-500 md:text-xl">NodeJS and more on personal projects!</p>
        </div>
