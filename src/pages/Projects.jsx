...
export default function Projects() {
  return (
    <div className="cont mb-5 mt-2 grid grid-cols-4 flex-wrap gap-3.5 px-3.5 sm:px-0">
        ...
        <div className="">
          ...
          <div className="wrap grid grid-cols-4 grid-rows-3 flex-wrap gap-5 xl:grid-cols-3 ">
            {projectsList.map((project) => (
              <div
                className="col-span-full p-5 h-80 flex-wrap overflow-hidden rounded-xl bg-[#ffffff] shadow-md md:col-span-2 xl:col-span-1"
                key={project.id}
              >
                <p className="text-left font-bold text-gray-600 ">{project.name}</p>
      ...
      <div className="col-span-4 grid grid-cols-3 grid-cols-4  gap-3.5 lg:grid-cols-3 3xl:grid-cols-4">
        {projectsList.map((project) => (
          <div
            key={project.id}
            className="col-span-4 h-80 flex-wrap overflow-hidden rounded-xl bg-[#f5f4f3] p-6 hover:shadow-md md:col-span-2 lg:col-span-1 2xl:col-span-1 "
          >
            <p className="text-left font-bold text-gray-600 ">{project.name}</p>
            <p className="text-left text-gray-500 ">{project.description}</p>
          </div>
